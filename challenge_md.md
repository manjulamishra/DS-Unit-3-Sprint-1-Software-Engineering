...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Finding typoes which can throw errors. Run the code to see if it's working. Check for the styling to make it more readable.Tell the person what could have made the code more elegant to read. This is important to keep a uniform standard for code writting and reading. Also, if someone is trying to build on your code, then it's a great way to get the idea of your writting style. Also, if there are missing docstrings/comments, add them. 
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  Containers basically create a virtual environment with the right kind sof tools you think you will need for your projects. The containers will have it's own enivroment with it's own imports/modules/packages which has nothing to do with the local symtem to prevent incompalibility issues. For example: I create a container which has anaconda install inside with python 3.7 version, where I pip installed pandas, seaborn etc, so as long as I use this container to finish my project work requiring pandas and seaborn, i will have no issues no matter if my local anaconda has seaborn or even anaconda or not.
